...
public class UserResource {
    ...
    public StandardResponse<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        UserDTO updatedUser = userService.updateUser(userDTO).orElseThrow(() -> new CoExploreException(ResponseStatus.USER_UPDATE_FAIL));
    ...
    public StandardResponse<ListResult<UserDTO>> getAllUsers(Pageable pageable) {
        ...
        StandardResponse<ListResult<UserDTO>> response = new StandardResponse<ListResult<UserDTO>>(ResponseStatus.SUCCESS, listResult);
        return response;
    }
    ...
    public StandardResponse<UserDTO> getUser(@PathVariable String login) {
        ...
        UserDTO userDTO = userService.getUserWithAuthoritiesByLogin(login).map(UserDTO::new).orElseThrow(() -> new CoExploreException(ResponseStatus.USER_NOT_FOUND));
