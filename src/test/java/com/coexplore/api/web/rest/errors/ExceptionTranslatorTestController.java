package com.coexplore.api.web.rest.errors;
...
public class ExceptionTranslatorTestController {
    ...
    public void parameterizedError() {
        throw new CoExploreException(com.coexplore.api.common.response.ResponseStatus.BAD_REQUEST, "test parameterized error");
    }
