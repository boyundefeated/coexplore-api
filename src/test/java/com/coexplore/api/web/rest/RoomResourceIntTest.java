...
import com.coexplore.api.domain.Room;
import com.coexplore.api.repository.RoomRepository;
import com.coexplore.api.service.RoomService;
import com.coexplore.api.service.dto.RoomDTO;
import com.coexplore.api.service.mapper.RoomMapper;
...
public class RoomResourceIntTest {
    ...
    public void createRoom() throws Exception {
        ...
        assertThat(testRoom.getSeat()).isEqualTo(DEFAULT_SEAT);
    }
    ...
    public void updateRoom() throws Exception {
        ...
        assertThat(testRoom.getSeat()).isEqualTo(UPDATED_SEAT);
    }
